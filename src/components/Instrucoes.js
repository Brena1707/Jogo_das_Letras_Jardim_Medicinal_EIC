...
export default function Instrucoes({ mobile }) {
    ...
    const niveis = <div>
        ...
        <span style={{display:"flex"}}>
            <strong style={{ padding: "1em", paddingRight: "1em"}} >SPACE</strong>
            <strong style={{ paddingTop: "1em"}}>-</strong>
            <div style={{padding:"1em"}} >embaralha a palavra novamente</div>
        </span>
        <span style={{display:"flex"}}>
            <strong style={{ paddingLeft: "1em", paddingRight: "1em"}} >BACKSPACE</strong>
            <strong>-</strong>
            <div style={{ paddingLeft: "1em", paddingRight: "1em" }} >remove o último caractere inserido</div>
        </span>
    </div>
    ...
    const content =
        <div>
            <div style={{ padding: "1em",  width: mobile ? "75vw" : "50vw"}}>
                ...
                <p>Uma vez iniciado o jogo, o usuário inicia na fase 1 podendo chegar a fase 5. A fase define o número de palavras a serem desembaralhadas.</p>
            </div>
